        ...
        children: [
          ...
          Expanded(
            ...
            children: [
              Positioned.fill(
                ...
                child: PageView(
                  ...
                  children: [
                    ...
                    Image.asset(widget.coffee.image),
                  ],
                ),
              )),
              Align(
                      ...
                      return Transform.scale(
                        ...
                        child: Text(
                          ...
                          style: Theme.of(context)
                            ...
                            const Shadow(color: Colors.black54, blurRadius: 30),
                          ]),
                        ),
                      );
                    },
              ...
              Align(
                alignment: const Alignment(.7, -0.7),
                child: TweenAnimationBuilder<double>(
                  duration: const Duration(milliseconds: 600),
                  tween: Tween(begin: 1.0, end: 0.0),
                  curve: Curves.fastOutSlowIn,
                  builder: (context, value, child) {
                    return Transform.translate(
                        ...
                        child: Transform.rotate(angle: 4.28*value, child: child,),
                    );
                  },
